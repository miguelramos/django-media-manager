 ...
 *
 * Modified for django-media-manager by Yury Lapshinov (raagin)
 * 
 */
(function($) {
  $.fn.formset = function(opts) {
    ...
    var updateElementIndex = function(el, prefix, ndx) {
      ...
      if ($(el).has('input[class="vFileBrowseField"]')) {
        var a_fb_link = $('input.vFileBrowseField', el).next();
        if (a_fb_link.attr('href')) {
          a_fb_link.attr('href', a_fb_link.attr('href').replace(id_regex, replacement)); 
        }
      }
    };
